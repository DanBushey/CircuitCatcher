...
def generateHDFfileSingleTimeSeries(path):
    ...
    #path = '/data/JData/A/A57_GtACR_Mi1/A57_Data/20180601_A57/20180601-A62-16-flyc-001'
    ...
    hdf5_path = os.path.join(path, file1 + "ImageFile.hdf5")
    ...
    timefile, index= cc1.getFileContString(path, file1 + '.xml')
    relativeTime, absoluteTime = getTime(os.path.join(path, timefile.values[0]))
