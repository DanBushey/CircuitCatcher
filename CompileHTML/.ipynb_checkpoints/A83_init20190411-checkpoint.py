...
ExcelFile = str(Path(path1) / str(projectname + '_Data4_Summary.xlsx'))
output = str(Path(path1) / saveFig / "_Data4_SummaryOutput.xlsx")
...
crosses ['A83-100'] ={'LexA' : '76F05-LexAp65 in JK73A (Y/TM3)' }
crosses ['A83-102'] ={'LexA' : '58E02-LexA in attP40' }
...
rois = {'g5': [0.69, 0.09, 0.121] ,
                 ...
                 "b'p2a": [0.13, 0.70, 0.37],
 
                 "b'p2mp": [0.18, 0.55, 0.34],
